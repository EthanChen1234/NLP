    ...
    def project_layer_bilstm(self, lstm_outputs, name=None):
        ...
        with tf.variable_scope("project" if not name else name):
            ...
            with tf.variable_scope("logits"):
                ...
                pred = tf.nn.xw_plus_b(hidden, W, b)   #[ batch_size*num_steps, num_tags]

            return tf.reshape(pred, [-1, self.num_steps, self.num_tags])  #[ batch_size, num_steps, num_tags]
    ...
    def project_layer_idcnn(self, idcnn_outputs, name=None):
        ...
        with tf.variable_scope("project"  if not name else name):
            ...
            with tf.variable_scope("logits"):
                ...
                pred = tf.nn.xw_plus_b(idcnn_outputs, W, b)   #[batch_size,*num_steps,num_tags ]
